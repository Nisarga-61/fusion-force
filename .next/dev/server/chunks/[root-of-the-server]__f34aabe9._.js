...
"[project]/src/app/api/auth/register/strict/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    ].some((u)=>u.username.toLowerCase() === String(username).toLowerCase());
    ...
    const passwordHash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, salt);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.set(userId, {
        userId,
        username,
        email,
        passwordHash
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f34aabe9._.js.map